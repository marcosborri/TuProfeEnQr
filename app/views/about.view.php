...
<main>
    <div class="exercise-container-2">
        <div class="title-container">
            <h1>Acerca de <span class="span-4">Tu Profe en QR</span></h1>
            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-qrcode">
        ...
        <div class="texto-container">
            ...
            <p>Hoy, este proyecto representa no solo una propuesta vinculada a la <span class="span-1">actividad física y la accesibilidad</span>, sino también una manera de aportar algo positivo a la comunidad desde un lugar educativo, inclusivo y cercano para todas las personas.</p></br>
        </div>
    </div>
</main>
